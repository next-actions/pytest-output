...
class PolarionTestCaseContainer(PolarionContainer):
    ...
    def properties(self) -> PolarionProperties:
        ...
        properties = {
            ...
            "lookup-method": self.config.lookup_method,
            "polarion-custom-lookup-method-field-id": self.config.lookup_method_field_id,
            **custom,
        }

        return PolarionProperties(properties)
...
class PolarionTestRunContainer(PolarionContainer):
    ...
    def properties(self) -> PolarionProperties:
        ...
        properties = {
            ...
            "polarion-lookup-method": self.config.lookup_method,
